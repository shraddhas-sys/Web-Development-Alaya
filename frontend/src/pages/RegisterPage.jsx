...
const RegisterPage = ({ onRegisterSuccess, onGoToLogin }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Sending to Sanctuary:", payload);
      ...
      let finalError = serverMessage || "Something went wrong. Check if fields match backend requirements.";
      alert(finalError);
    } finally {
      setLoading(false);
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
              <div className="relative group">
                <input 
                  ...
                  className="peer w-full bg-transparent border-b border-stone-200 py-2 outline-none focus:border-[#C67347] transition-colors placeholder-transparent text-sm text-stone-800"
